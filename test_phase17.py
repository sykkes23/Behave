...
class TestPhase17(unittest.TestCase):
    ...
    def test_cohens_d(self):
        ...
        d1 = [1, 2, 3]
        d2 = [2, 3, 4]
        # differences are all 1, sd is 0, handled as 0.0 or something?
        self.assertEqual(cohens_d(d1, d2), 0.0)
        
        d1 = [1, 2, 3, 4]
        d2 = [3, 4, 4, 6] # diffs: 2, 2, 1, 2
        # mean_diff = 1.75
        # diffs: [2, 2, 1, 2] -> mean: 1.75. 
        self.assertAlmostEqual(cohens_d(d1, d2), 3.5, places=1)
        
    def test_bootstrap_ci(self):
        d1 = [82, 85, 80, 78, 81]
        d2 = [85, 88, 83, 85, 86]
        # All improved. CI should be strictly positive.
    ...
    def test_mcnemar(self):
        ...
        # b_pass_c_fail: 1 (the last one)
        # b_fail_c_pass: 2 (3rd and 4th)
        # b=1, c=2. chi_sq = 0
    ...
    def test_benjamini_hochberg(self):
        ...
        # 0.005 (rank 1) -> 0.005 * 4/1 = 0.02
        # 0.01  (rank 2) -> 0.01 * 4/2 = 0.02
        # 0.03  (rank 3) -> 0.03 * 4/3 = 0.04
        # 0.04  (rank 4) -> 0.04 * 4/4 = 0.04
