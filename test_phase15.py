...
class TestPhase15(unittest.TestCase):
    ...
    def test_selector_determinism_and_budget(self):
        ...
        # FULL strategy ignores limit
        man_full = selector.select(SelectionStrategy.FULL, limit=2)
        self.assertEqual(len(man_full.selected_tests), 10)
        
        # Budget Check
        # Since avg_cost defaults to 0.01 per test if no history
        # limit=10, cost per = 0.01. max_cost=0.035 should select only 3
    ...
    def test_selector_prioritization(self):
        ...
        # Add a critical failure history to t_crit
        ...
        # t_safe is 0.0 unless picked as sentinel (10.0)
